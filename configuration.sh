...
# FLAT only
DRY_UN_INTERFACE='em1'
DRY_UN_IP='192.168.1.80'
DRY_EX_INTERFACE='em2'
DRY_EX_IP='192.168.1.64'
...
# Using FLAT configuration instead of VLAN ($DRY_EX_IP)
NOVA_VNC_ADDRESS=$DRY_UN_IP
NOVA_NON_VNC_URL="http://$DRY_UN_IP:6080/vnc_auto.html"
